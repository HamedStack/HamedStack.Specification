...
/// <summary>
/// Represents a specification that checks if at most 'n' items in a collection satisfy another specification.
/// </summary>
/// <typeparam name="T">The type of the object containing the collection.</typeparam>
/// <typeparam name="TItem">The type of the items in the collection.</typeparam>
public class AtMostSpecification<T, TItem> : Specification<T>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="AtMostSpecification{T, TItem}"/> class.
    /// </summary>
    ...
    /// <param name="n">The maximum number of items that should satisfy the specification.</param>
    public AtMostSpecification(Expression<Func<T, IEnumerable<TItem>>> propertySelector, ISpecification<TItem> itemSpecification, int n)
    {
    ...
    public override Expression<Func<T, bool>> ToExpression()
    {
        ...
        var atMostExpression = Expression.LessThanOrEqual(countExpression, Expression.Constant(_n));
        return Expression.Lambda<Func<T, bool>>(atMostExpression, entityParameter);
    }
}